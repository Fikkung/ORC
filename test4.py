...
class OCRApp:
    ...
    def __init__(self, master):
        ...
        self.coordinates_label = Label(master, text="Left: , Top: , Right: , Bottom: ", font=self.label_font, bg="#f0f0f0")
    ...
    # แสดงค่า left, top, right, bottom ที่เลือกพื้นที่ใน log
      logging.info(f"Selected crop area: Left={self.crop_box[0]}, Top={self.crop_box[1]}, Right={self.crop_box[2]}, Bottom={self.crop_box[3]}")
    # หรือแสดงผลใน Label บน UI
      self.coordinates_label.config(text=f"Left: {self.crop_box[0]}, Top: {self.crop_box[1]}, Right: {self.crop_box[2]}, Bottom: {self.crop_box[3]}")
